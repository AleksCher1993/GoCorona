export const _menu = () => {
    ...
    if (menuArrows.length > 0) {
      menuArrows.forEach((menuArrow) => {
        menuArrow.addEventListener("click", () => {
          menuArrow.parentElement.classList.toggle("menu__open");
        });
      });
    }
  } else {
    ...
    function onMenuLinkClick(e) {
      ...
      if (
        ...
        if (iconMenu.classList.contains("menu__open")) {
          ...
          iconMenu.classList.remove("menu__open");
          menuBody.classList.remove("menu__open");
        }
        window.scrollTo({
          top: gotoBlockValue,
          behavior: "smooth",
  ...
  if (iconMenu) {
    iconMenu.addEventListener("click", () => {
      ...
      iconMenu.classList.toggle("menu__open");
